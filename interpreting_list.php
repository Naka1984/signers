...
<table class="interpreting_list">
    ...
    <tbody>
      <tr>
        <th><a href="http://localhost:8888/signers/videochat.html#" style="text-decoration: none">2022/01/29（土） 13:30</th>
        <td label="通訳分類"><p>医療</p></td>
        <td label="内容"><p>耳鼻咽喉科の受診（再診）</p></td>
        <td label="現場"><p>市立札幌病院　耳鼻咽喉科</p></td>
        <td label="通訳者名"><p>那珂　慎二</p></td>
      </tr>
      <tr>
        <th>2022/02/03（木） 14:00</th>
        <td label="通訳分類"><p>教育</p></td>
        <td label="内容"><p>息子の三者面談</p></td>
        <td label="現場"><p>札幌市立××中学校</p></td>
        <td label="通訳者名"><p>大村　結愛</p></td>
      </tr>
      <tr>
        <th>2022/02/10（木） 14:00</th>
        <td label="通訳分類"><p>行政</p></td>
        <td label="内容"><p>身体障害者手帳の更新</p></td>
        <td label="現場"><p>札幌市中央区役所　障がい福祉課</p></td>
        <td label="通訳者名"><p>皆川　優花</p></td>
      </tr>
    </tbody>
    <tr></tr>
  </table>
